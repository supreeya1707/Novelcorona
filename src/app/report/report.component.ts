  ...
  getDocumentDefinition() {
    ...
    const docDefinition = {
      ...
      content: [
        ...
        (this.dataNovelByID[0].novel_fever === 1) ?  {text:  '√', absolutePosition: {x: 183, y: 316}, style: 'fSize24'} : null,
        ...
        (this.dataNovelByID[0].novel_respirator === 1) ?  {text:  '√', absolutePosition: {x: 469, y: 316}, style: 'fSize24'} : null,
